...
const AboutUs = () => {
  ...
  return (
    <section className="md:pt-20 pb-10 pt-16 lg:pt-28 lg:dark:pb-20 px-4 sm:px-6 lg:px-8 bg-white dark:bg-slate-950 overflow-hidden relative">
      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
          ...
          <div className="relative h-[500px] md:h-[600px] w-full group">
            ...
            <div className="absolute top-[10%] left-[5%] w-[80%] h-[80%] border-2 border-emerald-100 dark:border-emerald-900/30 rounded-xs -z-10" />

            {/* Main Image (Deep Back) */}
            <div className="absolute top-0 left-0 w-[65%] h-[75%] rounded-xs overflow-hidden shadow-2xl z-10 border-4 border-white dark:border-slate-900 ring-1 ring-black/5 dark:ring-white/5">
              <Image
                src={caregiverImg}
            ...
            <div className="absolute top-[20%] right-0 w-[55%] h-[55%] rounded-xs overflow-hidden shadow-2xl z-20 border-4 border-white dark:border-slate-900 ring-1 ring-black/5 dark:ring-white/5">
              <Image
            ...
            <div className="absolute bottom-0 left-[20%] w-[50%] h-[40%] rounded-xs overflow-hidden shadow-2xl z-30 border-4 border-white dark:border-slate-900 ring-1 ring-black/5 dark:ring-white/5">
              <Image
            ...
            {/* Experience Badge */}
            <div className="absolute bottom-[10%] -right-4 lg:-right-8 bg-white dark:bg-slate-900 p-6 rounded-xs shadow-xl z-40 border border-emerald-100 dark:border-emerald-900/50 backdrop-blur-subtle">
