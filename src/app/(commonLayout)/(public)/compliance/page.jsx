...
export const metadata = {
  ...
  description:
    "Our rigorous standards for caregiver vetting and service quality.",
};
  ...
  return (
    <div className="bg-white dark:bg-slate-950 pb-20">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        ...
        <div className="bg-slate-50 dark:bg-slate-900 rounded-xs p-8 md:p-12 border border-slate-200 dark:border-slate-800">
          <div className="text-center max-w-2xl mx-auto mb-16">
            <h2 className="text-3xl font-bold text-slate-900 dark:text-white mb-4">
              Our Vetting Process
            </h2>
            <p className="text-slate-600 dark:text-slate-400">
              Only the top 5% of applicants make it onto our platform. Here is
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 relative">
            ...
            {vettingSteps.map((step, idx) => (
              ...
              >
                <div
                  className={`w-24 h-24 rounded-full flex items-center justify-center mb-6 border-4 border-white dark:border-slate-900 shadow-xl ${step.color} transition-transform duration-500 group-hover:scale-110`}
                >
        ...
        <div className="mt-20 grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
          <div className="space-y-6">
            ...
            <p className="text-lg text-slate-600 dark:text-slate-300 leading-relaxed">
              Carevia operates in full compliance with local healthcare
              regulations. We maintain comprehensive liability insurance and
              adhere to strict data privacy laws (Digital Security Act).
            </p>
            <div className="flex gap-4">
              <div className="flex items-center gap-2 px-4 py-3 bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xs">
          ...
          <div className="relative h-80 rounded-xs overflow-hidden bg-gradient-to-br from-emerald-600 to-teal-700 shadow-2xl p-10 flex flex-col justify-center items-center text-center text-white">
            ...
            <p className="text-emerald-100">
              Zero compromise on safety and legal standards.
            </p>
          </div>
        </div>
      </div>
